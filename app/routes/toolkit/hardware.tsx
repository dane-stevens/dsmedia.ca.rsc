      ...
      <div className="flex flex-col gap-8">
        ...
        <div className="flex gap-5 justify-center flex-wrap">
          {products?.map((product, i) => {
            return (
              <a target="_blank" rel="noopener noreferrer" href={product.url} className="text-center block border border-zinc-800 px-4 py-8 rounded-lg w-full md:max-w-1/3 lg:max-w-1/4 xl:max-w-1/5 hover:border-emerald-600">
